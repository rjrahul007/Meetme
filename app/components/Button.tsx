  ...
  return (
    <View className="absolute top-16 left-0 right-0 items-center z-10 px-6">
      <View className="flex-row items-center">
        ...
        {/* Satellite toggle next to visibility */}
        <TouchableOpacity
          onPress={toggleMapType}
          activeOpacity={0.85}
          className={`ml-3 w-12 h-12 rounded-full items-center justify-center shadow-md border-2 ${isDark ? "bg-slate-800/90 border-slate-700/50" : "bg-white border-slate-200"}`}
        >
          <Ionicons
